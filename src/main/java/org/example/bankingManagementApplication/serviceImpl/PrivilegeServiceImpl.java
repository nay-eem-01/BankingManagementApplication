...
public class PrivilegeServiceImpl implements PrivilegeService {
    ...
    public Privilege findByPrivilegeName(String privilegeName) {
        return privilegeRepository.findByPrivilegeName(privilegeName).orElseThrow(()-> new ResourceNotFoundException("Privilege not found"));
    }

    @Override
    public Privilege findByPrivilegeId(Long id) {
        return privilegeRepository.findById(id).orElseThrow(()-> new ResourceNotFoundException("Privilege not found"));
    }
}
